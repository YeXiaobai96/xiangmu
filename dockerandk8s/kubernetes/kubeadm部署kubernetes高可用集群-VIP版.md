...
![stacked](C:\Users\ZX\Pictures\kubernetes-stacked.png)

**external etcd cluster**架构图

![external](C:\Users\ZX\Pictures\kubernetes-external.png)
...
1. 使用[阿里云镜像仓库](<https://opsx.alibaba.com/mirror?lang=zh-CN>)，配置Docker和kubernetes的yum源。
